...
import EstoqueVisaoGeral from './pages/admin/estoque/EstoqueVisaoGeral';
  ...
  return (
    <Routes>
      ...
      <Route path="/admin" element={
        ...
        <Route path="painel/plataformas" element={<PainelPlataformas />} />
        ...
        <Route path="estoque/catalogo" element={<EstoqueCatalogo />} />
