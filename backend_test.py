...
class HRSystemTester:
    ...
    def run_all_tests(self):
        ...
        test_sequence = [
            ...
            ("Master Admin Login", self.test_admin_login),
            ("Login Wrong Password", self.test_login_wrong_password),
            ("Password Validation Short", self.test_password_validation_short),
            ("Get Current User No Password", self.test_get_current_user_no_password),
            ("Change Password", self.test_change_password),
            ("Change Password Wrong Current", self.test_change_password_wrong_current),
            ("Company CRUD", self.test_company_crud),
            ("Location CRUD", self.test_location_crud),
            ("Employee CRUD", self.test_employee_crud),
            ("Employee Must Change Password", self.test_employee_must_change_password),
            ("Reset Employee Password", self.test_reset_employee_password),
